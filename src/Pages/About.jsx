...
export default function About() {
    return (
        <div>
            <Navbar />
            <div className="md:flex flex-row xs:flex-row sm:flex-row justify-center items-center md:gap-0 text-center md:text-left xs:p-5 sm:p-4 md:p-28 mb-24">
                <div>
                    ...
                    <div className="xs:mb-5 sm:mb-7 text-lg">
                        <p>Hello, my name is Kimberly Encinas, and I have a passion for creating websites. Ever since my CS class in high school, I've developed a love for computers and technology.
                            Besides being a web developer, I love fashion, art, music, and video games :)</p>
                    </div>
                </div>
                <div className="xs:order-1 sm:order-1">
                    <img src={PlaceholderImg} className="md:mt-3 md:mr-10 sm:w-96 md:w-svw md:ml-20" />
                </div>
            </div>
            <Socials />
        </div>
