    ...
    return (
        <div>
            ...
            <div className="max-w-[800px] mt-[-100px] w-full h-screen mx-auto text-center flex flex-col justify-center md:text-left gap-5">
                <h2 className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-pink-500 to-blue-500 md:text-4xl sm:text-4xl text-4xl font-semibold">About Me</h2>
