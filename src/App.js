  ...
  return (
    <div>
      ...
      <div className="main-content justify-center items-center p-7">
        ...
        <h1 className="block text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-customPurple to-customPink text-5xl font-semibold">Kimberly Encinas</h1>
