    ...
    return (
        <div className="App-header">
            <div className="standard-navbar hidden md:flex justify-end gap-7 p-5 font-medium max-w-[1240px] mx-auto">
                <Link to="/" className="hover:text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-customPurple to-customPink">Home</Link>
                <Link to="/about" className="hover:text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-customPurple to-customPink">About</Link>
                <Link to="/projects" className="hover:text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-customPurple to-customPink">Projects</Link>
                <Link to="/contact" className="hover:text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-customPurple to-customPink">Contact</Link>
