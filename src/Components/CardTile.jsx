...
export default function CardTile({ cardImg, cardTitle, cardDescription, githubLink }) {
    return (
        <div>
            <div className="bg-gray-800 bg-opacity-70 rounded-lg w-60 flex flex-col justify-center items-center">
                <img src={cardImg} alt={cardTitle} className="w-full h-40 object-cover rounded-t-lg" />
